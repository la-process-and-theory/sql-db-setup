...
db_password <- 'testsql!'
db_name <- 'oudb'
db_host <- 'database-1.cyxqbskvqdbe.us-east-2.rds.amazonaws.com'
db_port <- 3306
...
set.seed(7)
n <- 78
x <- data.frame("ID" = stri_rand_strings(n, 6), "age" = sample(1:16,n,T), "year" = sample(1990:2020, n, T))
y <- data.frame("ID"= x$ID, "score"=sample(studentAssessment$score, n, T), "treatment"=sample(c(1, 0), n, TRUE))

dbWriteTable(mydb, "participants", x)
dbWriteTable(mydb, "ScoresByGroup", y)
...
dbGetQuery(mydb, "SELECT ID AS 'ParticipantID', score FROM ScoresByGroup ORDER BY score DESC LIMIT 20;")

#Read the other table according to a condition of one of the variables.
dbGetQuery(mydb, "SELECT * FROM participants WHERE age>12 ORDER BY age;")
...
dbGetQuery(mydb, "SELECT * FROM participants;")
dbGetQuery(mydb, "INSERT INTO participants (age, year) VALUES ('32', '2021'); ")
dbGetQuery(mydb, "SELECT * FROM participants ORDER BY ID")
dbGetQuery(mydb, "DELETE FROM participants WHERE age=32")

dbGetQuery(mydb, "SELECT * FROM ScoresByGroup")
dbGetQuery(mydb, "UPDATE ScoresByGroup SET score=78 WHERE row_names=1;")
dbGetQuery(mydb, "SELECT * FROM ScoresByGroup")
dbGetQuery(mydb, "DELETE FROM ScoresByGroup WHERE row_names=1;")
...
dbGetQuery(mydb,"CREATE TABLE ScoresByGroup_2 (
  ID TEXT,
  score INTEGER, 
  treatment INTEGER
  );")

dbGetQuery(mydb, "INSERT INTO ScoresByGroup_2 (ID, score, treatment) SELECT ID, score, treatment FROM ScoresByGroup;")
dbGetQuery(mydb, "SELECT * FROM ScoresByGroup_2" )
dbGetQuery(mydb, "DROP TABLE IF EXISTS ScoresByGroup ;") 
...
dbGetQuery(mydb,"INSERT INTO test2 (student) VALUES (NULL);")
...
dbGetQuery(mydb,"CREATE TABLE participants_2 (
      ID TEXT, 
      age INTEGER DEFAULT 0, 
      year INTEGER 
      );")
dbGetQuery(mydb, "INSERT INTO participants_2 (ID, age, year) SELECT ID, age, year FROM participants;")
dbGetQuery(mydb, "INSERT INTO participants_2 (ID, year) VALUES('a', 1990);")
dbGetQuery(mydb, "SELECT * FROM participants_2 ORDER BY age")
dbGetQuery(mydb, "DROP TABLE IF EXISTS participants_2;")
...
dbListTables(mydb)
dbGetQuery(mydb, "SELECT * FROM participants;")
dbGetQuery(mydb, "ALTER TABLE participants ADD projectnumber INTEGER DEFAULT 3")
dbGetQuery(mydb, "SELECT * FROM participants;")
dbGetQuery(mydb, "ALTER TABLE participants DROP COLUMN projectnumber")
dbGetQuery(mydb, "SELECT * FROM participants;")
...
dbListTables(mydb)
dbGetQuery(mydb, "CREATE TABLE treatment ( 
           numID INTEGER AUTO_INCREMENT PRIMARY KEY,
           treatment INTEGER, 
           score INTEGER, 
           ID TEXT 
           );")

dbGetQuery(mydb, "INSERT INTO treatment (treatment, score, ID) VALUES (1, 46, 'abcdef');")
dbGetQuery(mydb, "SELECT * FROM treatment;")
...
dbListTables(mydb)
dbGetQuery(mydb, "SELECT * FROM participants")
dbGetQuery(mydb, "SELECT * FROM participants WHERE age<15 AND ID LIKE '_y%';")
...
dbGetQuery(mydb, "SELECT * FROM participants")
dbGetQuery(mydb, "INSERT INTO participants (ID, age, year) VALUES ('zO74Fn', 1, 2008);")
dbGetQuery(mydb, "SELECT ID FROM participants WHERE age<2 AND ID LIKE '_o%';")
dbGetQuery(mydb, "SELECT DISTINCT ID FROM participants WHERE age<2 AND ID LIKE '_o%';")
...
dbGetQuery(mydb, "SELECT * FROM ScoresByGroup_2;")
dbGetQuery(mydb,"SELECT *
           FROM participants AS l 
           LEFT JOIN ScoresByGroup_2 AS r ON l.ID = r.ID")
