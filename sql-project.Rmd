...
db_password <- 'testsql!'
db_name <- 'oudb'
db_host <- 'database-1.cxqcxbk8anhe.us-east-2.rds.amazonaws.com'
db_port <- 3306
...
library(dplyr)
toy1 <- select(studentInfo,id_student,gender,region,studied_credits,final_result)
toy1<-toy1[c(1:30),]
toy2 <- select(studentAssessment,id_assessment,id_student,date_submitted,score)
toy2<-toy2[c(1:30),]

dbWriteTable(mydb,"studentInfo_subset",toy1)
dbWriteTable(mydb,"studentAssessment_subset",toy2)
```
...
dbReadTable(mydb,'studentInfo_subset')
dbGetQuery(mydb,"SELECT id_student AS 'ID',gender,region FROM studentInfo_subset ORDER BY id_student DESC LIMIT 20;")

#Read the other table according to a condition of one of the variables.
dbReadTable(mydb,"studentAssessment_subset")
dbGetQuery(mydb,"SELECT * FROM studentAssessment_subset WHERE score < 70;")
...
dbGetQuery(mydb, "INSERT INTO studentInfo_subset (id_student, gender, region, studied_credits) VALUES ('00001', 'M', 'London Region', '120');")
dbGetQuery(mydb, "UPDATE studentAssessment_subset SET score = '20' WHERE id_student = 11391;")

dbGetQuery(mydb,"SELECT * FROM studentInfo_subset ORDER BY id_student;")
dbGetQuery(mydb,"SELECT * FROM studentAssessment_subset ORDER BY id_student;")

dbGetQuery(mydb, "DELETE FROM studentInfo_subset WHERE id_student = 00001;")
dbGetQuery(mydb, "DELETE FROM studentAssessment_subset WHERE id_student = 11391;")
...
dbGetQuery(mydb,"
           INSERT INTO toy1 (id_student,gender,region,studied_credits,final_result) 
           SELECT id_student,gender,region,studied_credits,final_result 
           FROM studentInfo_subset;")

dbGetQuery(mydb,"SELECT * FROM toy1;")

dbGetQuery(mydb, "DROP TABLE IF EXISTS studentInfo_subset;")
...
dbGetQuery(mydb, "ALTER TABLE toy1 ADD email INTEGER DEFAULT 1 ;")
dbGetQuery(mydb,"SELECT * FROM toy1;")
...
dbGetQuery(mydb,"INSERT INTO toy1 (id_student,gender,region,studied_credits,final_result) 
           VALUES('11391','M','East Anglian Region', '240', 'Pass');")
dbGetQuery(mydb,"SELECT DISTINCT * FROM toy1;")
...
dbGetQuery(mydb,"SELECT toy1.gender, studentAssessment_subset.score
                FROM toy1
                LEFT JOIN studentAssessment_subset ON toy1.id_student = studentAssessment_subset.id_student;")
