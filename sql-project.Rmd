...
db_password <- 'testsql!'
db_name <- 'oudb'
db_host <- 'database-1.czhnzm3tk0b5.us-east-2.rds.amazonaws.com'
db_port <- 3306
...
dbGetQuery(mydb, "SELECT gdprice AS 'goods price' FROM goods LIMIT 20;")
...
dbGetQuery(mydb, "INSERT INTO users (uid, uname) VALUES (31, 'Yucheng');")
...
dbGetQuery(mydb, "DELETE FROM users WHERE uid = 3;1")
