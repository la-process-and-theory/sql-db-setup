...
db_user <- 'mdav2021'
db_password <- 'craZy2020'
db_name <- 'oudb'
db_host <- 'database-1.c6z2voywt9q1.us-east-2.rds.amazonaws.com'
db_port <- 3306
...
dbWriteTable(mydb, "studentInfo", studentInfo, overwrite = TRUE)
dbWriteTable(mydb, "studentAssessment", studentAssessment, overwrite = TRUE)
dbWriteTable(mydb, "courses", courses, overwrite = TRUE)
dbWriteTable(mydb, "studentRegistration", studentRegistration,  overwrite = TRUE)
...
dbGetQuery(mydb, "SELECT id_student AS 'Student ID', gender, region, imd_band FROM Table1 ORDER BY imd_band DESC LIMIT 20;")
...
#Inserting data into the table manually
#dbGetQuery(mydb, "INSERT INTO Stable1 VALUES ( 11391, 'M','East Anglian Region','90-100%');")
#dbGetQuery(mydb, "INSERT INTO Stable1 VALUES ( 24800, 'F','Scotland','20-30%' );")
#dbGetQuery(mydb, "INSERT INTO Stable1 VALUES ( 30268, 'F', 'North Western Region','30-40%' );")
...
dbReadTable(mydb, 'Stable2')

dbGetQuery(mydb, "DROP TABLE Stable2;")
```
...
#dbGetQuery(mydb, "SELECT DISTINCT id_student FROM Table2;")

#dbGetQuery(mydb, "SELECT DISTINCT id_student, highest_education FROM Table2;")
dbReadTable(mydb, 'Table2')
...
dbGetQuery(mydb, "ALTER TABLE Stable1 ADD ComId INTEGER DEFAULT 99 ")
dbGetQuery(mydb, "ALTER TABLE Table2 ADD ComId INTEGER DEFAULT 99 ")

dbGetQuery(mydb, "SELECT * FROM Stable1;")
dbGetQuery(mydb, "SELECT * FROM Table2;")


dbGetQuery(mydb,"SELECT l.description AS Stable1, r.description AS Table2 
           FROM Stable1 AS l 
           RIGHT JOIN Table2 AS r ON l.ComId = r.ComId")
