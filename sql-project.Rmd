...
BEGIN
  ...
  SET i = 0;
    lp : LOOP                               　　　
        INSERT INTO df3 VALUES(i+1,i+31,'a');　　
        SET i = i + 1;                      　　　　
        IF i > 29 THEN                   　　　　
                    LEAVE lp;
            END IF;
...
dbGetQuery(mydb, "ALTER TABLE df1 ADD number3 INTEGER DEFAULT 3 ")

dbGetQuery(mydb, "SELECT * FROM df1;")
dbGetQuery(mydb, "ALTER TABLE df1 DROP COLUMN number3;")
```
...
dbGetQuery(mydb, "SELECT number1, number2 FROM df1 WHERE number1 > 3 AND number2 < 40 ORDER BY number1 DESC;")
```
...
dbGetQuery(mydb,"INSERT INTO df1 (row_names, number1, character1, number2) VALUES ('1', 1, 'a', 31);")
dbGetQuery(mydb, "SELECT * FROM df1;")
dbGetQuery(mydb, "SELECT DISTINCT * FROM df1;")
```
...
dbGetQuery(mydb,"SELECT l.number1 AS df1, r.number1 AS df2 
           FROM df1 AS l
