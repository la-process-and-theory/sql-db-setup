...
db_password <- 'testsql!'
db_name <- 'oudb'
db_host <- 'database-1.chtdqs80jv9d.us-east-2.rds.amazonaws.com'
db_port <- 3306
...
dbGetQuery(mydb,"DROP TABLE IF EXISTS toydata2")
dbGetQuery(mydb,"DROP TABLE IF EXISTS toydata3")
a<-c(1:20, letters[1:20])
b<-c(letters[5:23], 15:35)
c<-c(0:15, letters[1:10], 16:29)
toydata1<-as.data.frame(cbind(a,b,c))
dbWriteTable(mydb, "toydata1", toydata1)

d<-c(1:30)
e<-c(letters[1:20], 1:10)
f<-c(1:20, letters[1:10])
toydata2<-as.data.frame(cbind(d,e,f))
...
dbGetQuery(mydb, "SELECT d AS 'DDDDD', e FROM toydata2 ORDER BY e DESC LIMIT 20;")
#Read the other table according to a condition of one of the variables.
dbGetQuery(mydb, "Select a FROM toydata1 ORDER BY b DESC")
```
...
dbGetQuery(mydb, "INSERT INTO toydata1 (a, b) VALUES ('aaaaa', 'bbbbb');")
dbGetQuery(mydb, "UPDATE toydata2 SET e = 'changedvalue' WHERE f=1;")
dbGetQuery(mydb, "SELECT * FROM toydata1")
dbGetQuery(mydb, "SELECT * FROM toydata2")
dbGetQuery(mydb, "DELETE FROM toydata1 WHERE a = 'aaaaa';")
dbGetQuery(mydb, "DELETE FROM toydata2 WHERE e = 'changedvalue';")
```
...
dbGetQuery(mydb,"CREATE TABLE toydata3 (SELECT * FROM toydata1);")
...
dbGetQuery(mydb,"CREATE TABLE toydata1(
   d INT DEFAULT 0,
   e TEXT,
   f TEXT
)")
dbGetQuery(mydb,"INSERT INTO toydata1 (d,e,f) VALUES ('50','X','Y');")
dbGetQuery(mydb, "SELECT * FROM toydata1;")
dbGetQuery(mydb,"DROP TABLE IF EXISTS toydata1")
```
...
toydata2<-as.data.frame(cbind(d,e,f))
dbWriteTable(mydb, "toydata2", toydata2)
dbGetQuery(mydb,"SELECT d from toydata2 WHERE d>20 ORDER BY d DESC;")
```
...
dbGetQuery(mydb,"INSERT INTO toydata2 (d) VALUES ('1');")
dbGetQuery(mydb, "SELECT d FROM toydata2;")
dbGetQuery(mydb, "SELECT DISTINCT d FROM toydata2;")
```
...
c<-c(0:15, letters[1:10], 16:29)
id<-c(1:40)
toydata1<-as.data.frame(cbind(a,b,c,id))
dbWriteTable(mydb, "toydata1", toydata1)
dbGetQuery(mydb, "SELECT * FROM toydata1;")

d<-c(1:40)
e<-c(letters[1:20], 1:20)
f<-c(1:20, letters[1:20])
id<-c(11:50)
toydata2<-as.data.frame(cbind(d,e,f,id))
dbWriteTable(mydb, "toydata2", toydata2)
dbGetQuery(mydb, "SELECT * FROM toydata2;")
